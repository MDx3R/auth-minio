...
from common.application.repositories.key_value_cache import IKeyValueCache, T


class TTLKeyValueCache(IKeyValueCache[T]):
    def __init__(self, store: IKeyValueStore[T], ttl: int | None = 300):
        self.store = store
        self.ttl = ttl
