...
from common.application.interfaces.transactions.unit_of_work import (
    IUnitOfWork,
)
...
class UnitOfWork(IUnitOfWork):
    ...
    async def _finalize_transaction(self, has_error: bool):
        if not self._transaction_exists():
            return
    ...
    def _set_transaction(self, session: Transaction):
